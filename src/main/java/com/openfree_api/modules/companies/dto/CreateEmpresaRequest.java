...
public class CreateEmpresaRequest {
    ...
    @Size(
            max = 120,
            message = "O nome fantasia deve ter no máximo 120 caracteres."
    )
    ...
    @Pattern(
            ...
            message =
                    "O CNPJ deve conter 14 dígitos ou estar no formato 00.000.000/0000-00."
    )
    private String cnpj;
    ...
    @Size(
            max = 500,
            message = "A URL da logo deve ter no máximo 500 caracteres."
    )
    private String logo;
